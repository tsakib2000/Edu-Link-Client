        ...
        <div className="grid lg:grid-cols-3 gap-10">
          <div className="lg:col-span-2 max-lg:order-1">
            ...
            <form className="mt-16 max-w-lg">
              ...
              <div className="flex flex-wrap gap-4 mt-8">
                <button type="button" className="min-w-[150px] px-6 py-3.5 text-sm bg-gray-100 text-gray-800 rounded-md hover:bg-gray-200">Back</button>
          ...
          <div className="bg-gray-100 p-6 rounded-md">
            ...
            <ul className="text-gray-800 mt-8 space-y-4">
              ...
              <li className="flex flex-wrap gap-4 text-sm">Echo Elegance <span className="ml-auto font-bold">$200.00</span></li>
              <li className="flex flex-wrap gap-4 text-sm">VelvetGlide Boots <span className="ml-auto font-bold">$300.00</span></li>
              <li className="flex flex-wrap gap-4 text-sm">Tax <span className="ml-auto font-bold">$100.00</span></li>
              <li className="flex flex-wrap gap-4 text-sm font-bold border-t-2 pt-4">Total <span className="ml-auto">$750.00</span></li>
            </ul>
          </div>
        </div>
      </div>
